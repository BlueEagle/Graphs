...
add_friendship() would be called an average of 1000 times. The populate_graph() function uses a loop to iterate through each user, and then it iterates through the average number of friends that each user will have. This is an O(n^2) algorithm.
